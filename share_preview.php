...
<div class="container">
  ...
  <div class="card-body">
    ...
    <p class="card-text"><small class="text-muted"><i class="far fa-thumbs-up"> <?= $row['share_liked'];?></i></small></p> 
    <a href="#" class="tag <?=empty(explode("," ,$row['share_hash'])[0]) ? 'visually-hidden' : ''?>"><small class="text-muted"> <?=explode("," ,$row['share_hash'])[0] ?? ''?></small></a>  
    <a href="#" class="tag <?=empty(explode("," ,$row['share_hash'])[1]) ? 'visually-hidden' : ''?>"><small class="text-muted "> <?=explode("," ,$row['share_hash'])[1] ?? ''?></small></a>  
    <a href="#" class="tag <?=empty(explode("," ,$row['share_hash'])[2]) ? 'visually-hidden' : ''?>"><small class="text-muted "> <?=explode("," ,$row['share_hash'])[2] ?? ''?></small></a>  
  </div>
</div>
<?php endforeach; ?>
</div>
